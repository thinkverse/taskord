    ...
    public function run(Faker $faker)
    {
        foreach (range(1, 1000) as $index) {
            DB::table('tasks')->insert([
                ...
                'done_at' => $faker->dateTimeBetween($startDate = '-365 days', $endDate = 'now'),
                'created_at' => $faker->dateTimeBetween($startDate = '-365 days', $endDate = 'now'),
                'updated_at' => $faker->dateTimeBetween($startDate = '-365 days', $endDate = 'now'),
            ]);
        }
