<ul class="nav nav-pills justify-content-center mb-3">
    <li class="nav-item">
        <a class="nav-link rounded-pill {{ Route::is('staff.stats') ? 'active' : '' }}"
    ...
    <li class="nav-item">
        <a class="nav-link rounded-pill {{ Route::is('staff.users') ? 'active' : '' }}"
            href="{{ route('staff.users') }}">
            <x-heroicon-o-users class="heroicon heroicon heroicon-18px" />
            Users
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link rounded-pill {{ Route::is('staff.tasks') ? 'active' : '' }}"
    ...
    <li class="nav-item">
        <a class="nav-link rounded-pill {{ Route::is('staff.activities') ? 'active' : '' }}"
            href="{{ route('staff.activities') }}">
            <x-heroicon-o-fire class="heroicon heroicon-18px" />
            Activities
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link rounded-pill {{ Route::is('staff.products') ? 'active' : '' }}"
    ...
    <li class="nav-item">
        <a class="nav-link rounded-pill {{ Route::is('staff.jobs') ? 'active' : '' }}"
            href="{{ route('staff.jobs') }}">
