<div class="col-sm">
    <div class="card mb-4">
        <ul class="list-group list-group-flush">
            ...
            <a
                class="list-group-item text-dark pt-2 pb-2 {{ Route::is('user.settings.profile') ? 'active text-white' : '' }}"
            ...
            <a
                class="list-group-item text-dark pt-2 pb-2 {{ Route::is('user.settings.account') ? 'active text-white' : '' }}"
            ...
            <a
                class="list-group-item text-dark pt-2 pb-2 {{ Route::is('user.settings.appearance') ? 'active text-white' : '' }}"
            ...
            <a
                class="list-group-item text-dark pt-2 pb-2 {{ Route::is('user.settings.products') ? 'active text-white' : '' }}"
            ...
            <a
                class="list-group-item text-danger pt-2 pb-2 {{ Route::is('user.settings.delete') ? 'bg-danger text-white' : '' }}"
