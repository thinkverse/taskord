                    ...
                    <li class="list-group-item pt-3 pb-3">
                        <div class="d-flex align-items-center">
                            <a href="{{ route('product.done', ['slug' => $product->slug]) }}">
                                <img loading=lazy class="rounded avatar-50 mt-1 ms-2" src="{{ Helper::getCDNImage($product->avatar) }}" height="50" width="50" alt="{{ $product->slug }}'s avatar" />
                            </a>
                            <span class="ms-3">
                            ...
                            <a class="ms-auto" href="{{ route('user.done', ['username' => $product->owner->username]) }}">
                                <img loading=lazy class="rounded-circle float-end avatar-30 mt-1 ms-2" src="{{ Helper::getCDNImage($product->owner->avatar) }}" height="50" width="50" alt="{{ $product->owner->username }}'s avatar" />
                            </a>
                        </div>
                    </li>
                @endforeach
                    ...
                    <li class="list-group-item pt-3 pb-3">
                        <div class="d-flex align-items-center">
                            <a href="{{ route('user.done', ['username' => $user->username]) }}">
                                <img loading=lazy class="rounded-circle avatar-50 mt-1 ms-2" src="{{ Helper::getCDNImage($user->avatar) }}" height="50" width="50" alt="{{ $user->username }}'s avatar" />
                            </a>
                            <span class="ms-3">
