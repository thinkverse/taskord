<div class="col-lg-8">
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#resetAccountModal">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button wire:loading.attr="disabled" wire:click="resetAccount" type="button" class="btn btn-danger">Reset Account</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="deleteAccountModal" tabindex="-1" aria-labelledby="deleteAccountModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button wire:loading.attr="disabled" wire:click="deleteAccount" type="button" class="btn btn-danger">Delete Account</button>
                </div>
            </div>
        </div>
    </div>
