<div class="card border-warning mb-4">
    ...
    <div class="card-body">
        ...
        <div class="mb-2">
            ...
            <span wire:loading wire:target="enrollStaff" class="small ml-2 text-success fw-bold">Enrolling...</span>
        </div>
        <div class="mb-2">
            ...
            <span wire:loading wire:target="enrollPatron" class="small ml-2 text-success fw-bold">Enrolling...</span>
        </div>
        <div class="mb-2">
            ...
            <span wire:loading wire:target="enrollDarkMode" class="small ml-2 text-success fw-bold">Enrolling...</span>
        </div>
        <div class="mb-2">
            ...
            <span wire:loading wire:target="enrollDeveloper" class="small ml-2 text-success fw-bold">Enrolling...</span>
        </div>
        <div class="mb-2">
            <input wire:click="privateUser" id="privateUser" class="form-check-input" type="checkbox" {{ $user->isPrivate ? 'checked' : '' }}>
            <label for="privateUser" class="ml-1 text-danger fw-bold">Make user Private</label>
            <span wire:loading wire:target="privateUser" class="small ml-2 text-danger fw-bold">Enrolling...</span>
        </div>
        <div>
            <input wire:click="verifyUser" id="verifyUser" class="form-check-input" type="checkbox" {{ $user->isVerified ? 'checked' : '' }}>
            <label for="verifyUser" class="ml-1 text-success fw-bold">Verify this user</label>
            <span wire:loading wire:target="verifyUser" class="small ml-2 text-success fw-bold">Verifying...</span>
        </div>
        @if (!$user->isStaff)
        <div class="mt-3">
            ...
            <span wire:loading wire:target="Masquerade" class="small ml-2 text-danger fw-bold">masquerading...</span>
        </div>
        @endif
        @if (!$user->isStaff)
        <hr>
        ...
        <div class="mt-2">
            ...
            <label for="flagUser" class="ml-1 text-danger fw-bold">Flag this user</label>
            <span wire:loading wire:target="flagUser" class="small ml-2 text-danger fw-bold">Flagging...</span>
        </div>
        <div class="mt-2">
            <input wire:click="suspendUser" id="suspendUser" class="form-check-input" type="checkbox" {{ $user->isSuspended ? 'checked' : '' }}>
            <label for="suspendUser" class="ml-1 text-danger fw-bold">Suspend this user</label>
            <span wire:loading wire:target="suspendUser" class="small ml-2 text-danger fw-bold">Suspending...</span>
        </div>
        <div class="mt-3">
            ...
            <span wire:loading wire:target="deleteTasks" class="small ml-2 text-danger fw-bold">Deleting...</span>
        </div>
        <div class="mt-2">
            ...
            <span wire:loading wire:target="deleteComments" class="small ml-2 text-danger fw-bold">Deleting...</span>
        </div>
        <div class="mt-2">
            ...
            <span wire:loading wire:target="deleteQuestions" class="small ml-2 text-danger fw-bold">Deleting...</span>
        </div>
        <div class="mt-2">
            ...
            <span wire:loading wire:target="deleteAnswers" class="small ml-2 text-danger fw-bold">Deleting...</span>
        </div>
        <div class="mt-2">
            ...
            <span wire:loading wire:target="deleteProducts" class="small ml-2 text-danger fw-bold">Deleting...</span>
        </div>
        <div class="mt-2">
            ...
            <span wire:loading wire:target="deleteUser" class="small ml-2 text-danger fw-bold">Deleting...</span>
        </div>
        @endif
    </div>
</div>
