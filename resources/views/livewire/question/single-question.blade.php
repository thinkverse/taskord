    ...
    <div class="card-body">
        ...
        <div class="d-flex align-items-center">
            <a href="{{ route('user.done', ['username' => $question->user->username]) }}">
                <img loading=lazy class="avatar-40 rounded-circle" src="{{ Helper::getCDNImage($question->user->avatar) }}" alt="{{ $question->user->username }}'s avatar" />
            </a>
            <span class="ms-2">
                <a
    ...
    <div class="card-body pt-1">
        ...
        <div class="mt-3">
            ...
            <a href="{{ route('question.question', ['id' => $question->id]) }}" class="avatar-stack text-dark">
                ...
                <img loading=lazy class="rounded-circle avatar avatar-30" src="{{ Helper::getCDNImage($answer[0]->user->avatar) }}" alt="{{ $answer[0]->user->username }}'s avatar" />
                @endforeach
