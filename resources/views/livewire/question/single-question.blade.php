        ...
        <div class="mt-3">
            @auth
                @if (auth()->user()->hasLiked($question))
                    <button role="button" class="btn btn-action btn-like me-1" wire:click="togglePraise" wire:loading.attr="disabled" wire:offline.attr="disabled" aria-label="Praises">
                ...
                @else
                    <button role="button" class="btn btn-action btn-outline-like me-1" wire:click="togglePraise" wire:loading.attr="disabled" wire:offline.attr="disabled" aria-label="Praises">
                        <span wire:loading wire:target="togglePraise" class="spinner-border spinner-border-task" role="status"></span>
