<span>
    ...
    <div class="align-items-center d-flex">
        ...
        <span class="ml-2">
            <a href="{{ route('user.done', ['username' => $task->user->username]) }}" class="status font-weight-bold text-dark" data-content="" data-id="{{ $task->user->id }}" data-html="true" data-toggle="popover" data-placement="top">
