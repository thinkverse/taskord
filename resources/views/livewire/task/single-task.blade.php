        ...
        <span class="ml-2">
            ...
            >
                ...
                @if ($task->user->isVerified)
                    <i class="verified fa fa-check-circle ml-1 text-primary" data-toggle="tooltip" data-placement="right" title="Verified"></i>
                @endif
                @if ($task->user->isPatron)
                    <a class="patron ml-1 small" href="{{ route('patron.home') }}" data-toggle="tooltip" data-placement="right" title="Patron">
                        {{ Emoji::handshake() }}
                    </a>
                @endif
