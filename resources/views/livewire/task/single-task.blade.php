<span>
    ...
    <div class="pt-3">
        ...
        <div class="pt-3">
            ...
            <button type="button" class="btn btn-task {{ $task->hidden ? 'btn-dark' : 'btn-outline-dark' }} ms-1" wire:click="hide" wire:loading.attr="disabled" wire:offline.attr="disabled" wire:key="{{ $task->id }}" title="Flag to admins" aria-label="Hide">
