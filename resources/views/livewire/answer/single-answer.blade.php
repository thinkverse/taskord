<div>
    ...
    <div class="card-body pt-1">
        ...
        <div class="mt-2">
            ...
            <button type="button" class="btn btn-task {{ $answer->hidden ? 'btn-dark' : 'btn-outline-dark' }} ms-1" wire:click="hide" wire:loading.attr="disabled" wire:offline.attr="disabled" wire:key="{{ $answer->id }}" title="Flag to admins" aria-label="Hide">
