                ...
                @foreach ($products as $product)
                    <div class="py-2 px-3">
                        ...
                        <span class="float-end">
                            ...
                            >
                                <img loading=lazy class="rounded-circle avatar-30 mt-1 me-0" src="{{ Helper::getCDNImage($product->user->avatar, 80) }}" height="30" width="30" alt="{{ $product->user->username }}'s avatar" />
                            </a>
                        </span>
                    </div>
                @endforeach
