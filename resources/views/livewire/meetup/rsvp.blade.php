<div class="card-footer text-muted">
    ...
    @else
    <button class="btn btn-task btn-outline-success text-dark float-end" wire:click="toggleRSVP" wire:loading.attr="disabled" aria-label="RSVP">
        ✅ RSVP
    </button>
    @endif
    @else
    <a class="btn btn-task btn-outline-secondary text-dark float-end" href="{{ route('login') }}" aria-label="RSVP">
        ✅ RSVP
    </a>
    @endauth
</div>
